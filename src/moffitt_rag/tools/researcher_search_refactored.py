...
class ResearcherSearchTool(BaseTool):
    ...
    def _parse_input(self, tool_input: Union[str, Dict]) -> tuple:
        """
        Parse the input to extract researcher_name and topic.
    ...
    def _run(self, tool_input: Union[str, Dict]) -> str:
        ...
        try:
            # Parse the input
            researcher_name, topic = self._parse_input(tool_input)
