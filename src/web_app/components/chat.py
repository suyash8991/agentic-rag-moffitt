...
src_dir = current_file.parent.parent.parent  # components/chat.py -> components -> web_app -> src
...
from utils.logging import get_logger, log_ui_event, QueryLogger
...
def invoke_agent(query: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        from agents.agent import create_researcher_agent
        import traceback
        import inspect
